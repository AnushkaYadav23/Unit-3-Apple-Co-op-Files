...
/*:
 Use the Show Result button to view the result inline, like you did on the previous page. You can think of each item in the array as having a number next to it, starting at zero like this:
 ...
 */
//devices[4]
//There are not enough items, as the list only goes up to three!
/*:
