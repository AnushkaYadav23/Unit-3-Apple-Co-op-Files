 ...
 */
var beachVote = 0
var chocolateFactoryVote = 0

for _ in tripDestinationVotes {
    
    switch ClassTripDestination.beach {
    case .beach:
        beachVote += 1
    default:
        chocolateFactoryVote += 1
        
    switch ClassTripDestination.chocolateFactory{
...
for _ in mascotVotes {
    switch SchoolMascotOption.marmot {
    case .marmot:
        marmotVote += 1
    default:
        neitherVote += 1
    switch SchoolMascotOption.salamander {
    case .salamander:
            salamaderVote += 1
    default:
        neitherVote += 1
