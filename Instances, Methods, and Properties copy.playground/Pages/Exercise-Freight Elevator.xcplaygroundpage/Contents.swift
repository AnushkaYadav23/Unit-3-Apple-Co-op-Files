...
var evenStrogerRope = TreehousePulley(weightCapacity: 20000)
var addLoadToBasket = light + light + light + medium + medium + heavy
ricketyRope.canHandleAdditionalLoad(addLoadToBasket)
strongerRope.canHandleAdditionalLoad(addLoadToBasket)
evenStrogerRope.canHandleAdditionalLoad(addLoadToBasket)
/*:
 - callout(Exercise): 
