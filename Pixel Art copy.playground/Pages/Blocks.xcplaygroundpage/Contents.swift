...
//block(x: 10, y: 10, width: 10, height: 5, color: .purple)
//block(x: 10, y: 15, width: 10, height: 5, color: .blue)
//block(x: 10, y: 20, width: 10, height: 5, color: .green)
//block(x: 10, y: 25, width: 10, height: 5, color: .red)
 ...
 */
func block2(x: Int, y: Int, width: Int, height: Int, color: Color){
    var pixels: [Pixel] = []
    
    for x in 0 ... x + width - 1{
        for y in 0 ... y + height - 1 {
...
block2(x: 4, y: 5, width: 10, height: 3, color: .blue)
