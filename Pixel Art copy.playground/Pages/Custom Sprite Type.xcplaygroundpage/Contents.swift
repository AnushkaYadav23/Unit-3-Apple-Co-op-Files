...
struct PersonSprite {
    ...
    // Create a draw() method. Its body can be identical to the person() function,as long as you've declared the properties correctly.
...
for _ in 1 ... 40 {
    ...
    var Anushka = PersonSprite(x: anushkaX, y: 5, headColor: .brown, torsoColor: .purple, legsColor: .gray, leftArmUp: true, rightArmUp: true)
    var Jessica = PersonSprite(x: jessicaX, y: 20, headColor: .brown, torsoColor: Color(hue: jessicaHug, saturation: 0.7, brightness: 1.0), legsColor: .gray, leftArmUp: true, rightArmUp: true)
