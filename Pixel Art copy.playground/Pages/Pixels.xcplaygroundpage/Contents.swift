...
display.setPixel(x: 5, y: 2, color: .cyan)
/*:
 ...
 */
display.setPixel(x: 8, y: 8, color: Color(red: 1.0, green: 0.0, blue: 4.0 ))

//: - callout(Exercise): Try creating a simple graphic by placing pixels of different colors on the display.
display.setPixel(x: 4, y: 4, color: .darkGray)
display.setPixel(x: 3, y: 7, color: .green)
