...
print(tabulator.tabulatedValues[mostPopularShow])
print(tabulator.tabulatedValues[leastPopularShow])
...
for _ in 1 ... 3 {
    let indexOfTheMax = indexOfMaximum(from: allShows)
    mostPopular.append(allShows[indexOfTheMax])
    allShows.remove(at: indexOfTheMax)
...
for _ in 1 ... 3 {
    let indexOfTheMin = indexOfMaximum(from: allShows)
    leastPopular.append(allShows[indexOfTheMin])
    allShows.remove(at: indexOfTheMin)
