...
let medianAbsoluteDeviation = tabulator.medianAbsoluteDeviation()
...
for show in tabulator.tabulatedValues {
    ...
    if show.count < median - medianAbsoluteDeviation {
        notVeryPopular.append(show)
    } else if show.count > median + medianAbsoluteDeviation {
...
print(notVeryPopular.count)
print(veryPopular.count)
print(moderatelyPopular.count)
