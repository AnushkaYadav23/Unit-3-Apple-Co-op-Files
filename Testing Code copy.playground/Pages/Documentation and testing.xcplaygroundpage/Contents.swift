...
/// - Note:The value for pennies can only be a positive interger from 0 to 255.
class PiggyBank {
    ...
    /// - Note:Value can cannot be greater than 255 and must be added to the current value of pennies
    ...
    /// - Note: Value cannot be greater than 255 or current value of pennies - Value will be subtracted from current value of pennies
...
//bank1.withdraw(pennies: 101)
bank1.deposit(pennies: 150)
bank1.balance()
//bank1.deposit(pennies: 100)
bank1.balance() == 255
