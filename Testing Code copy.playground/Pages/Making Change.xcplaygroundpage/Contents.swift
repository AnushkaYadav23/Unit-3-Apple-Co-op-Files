...
change(for: 100, purchasePrice: 56.25)
//change(for: 10, purchasePrice: 12)
//change(for: 1000, purchasePrice: 501)
change(for: 20, purchasePrice: 13.15)
/*:
...
change(for: 100, purchasePrice: 56.25) == [.ten, .ten, .ten, .ten, .one, .one, .one, .quarter, .quarter, .quarter]
change(for: 20, purchasePrice: 13.15) == [.five, .one, .quarter, .quarter, .quarter, .dime]

change(for: 10, purchasePrice: 2.75) == [.five, .one, .one,]
change(for: 100, purchasePrice: 56.25) == [.ten, .ten, .ten, .ten, .one, .one, .quarter, .quarter, .quarter]
change(for: 20, purchasePrice: 13.15) == [.five, .one, .quarter, .quarter, .dime]
/*:
