...
//pieChartView.wedges = [PieWedge(proportion: 0.15, color: Color(hue: 0.07, saturation: 2.5, brightness: 1.0), scale: 1, offset: 0), PieWedge(proportion: 0.23, color: Color(red: 0.05, green: 0.4, blue: 0.01), scale: 1, offset: 0), PieWedge(proportion: 0.35, color: Color(hue: 8.0, saturation: 1.0, brightness: 1.0, alpha: 0.5), scale: 1, offset: 0), PieWedge(proportion: 0.27, color: .cyan, scale: 1, offset: 0)]
...
pieChartView.wedges = [PieWedge(proportion: 0.15, color: .init(red: 3.0, green: 0.0, blue: 0.0, alpha: 0.1), scale: 1, offset: 0), PieWedge(proportion: 0.29, color: Color(red: 0.05, green: 0.4, blue: 0.01), scale: 1, offset: 0), PieWedge(proportion: 0.35, color: Color(hue: 8.0, saturation: 1.0, brightness: 1.0, alpha: 0.5), scale: 1, offset: 0), PieWedge(proportion: 0.27, color: .init(red: 0.0, green: 3.0, blue: 0.0, alpha: 0.1), scale: 1, offset: 0)]
...
func addWedge(withProportion: Double , color: Color) {
    pieChartView.wedges = [PieWedge(proportion: withProportion, color: color)]
}

func addKeyItem(withLabel: String, color: Color) {
    keyView.keyItems = [ChartKeyItem(color: color, name: withLabel)]
}
